...
export const AccommodationSection: React.FC<AccommodationSectionProps> = ({ onNavigateToMap }) => {
  return (
        ...
        <div className="p-6 md:p-8 lg:col-span-6 flex flex-col justify-between space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 bg-[#003580] hover:bg-[#00224f] text-white text-xs sm:text-sm font-bold py-3 px-5 rounded-xl shadow-md transition-colors"
            >
              <span>Bekijk op Booking.com</span>
