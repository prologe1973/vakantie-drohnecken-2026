...
export const TRIP_RESTAURANTS: TripRestaurant[] = [
  // Ma 7 sep — Dhronecken / Thalfang (lunch)
  {
    id: 'rauland-thalfang',
    name: 'Landgasthof Rauland',
    day: 'Dag 1',
    dayLabel: 'Ma 7 sep · Lunch',
    place: 'Thalfang',
    address: 'Kobusweg 4, 54424 Thalfang-Bäsch',
    cuisine: 'Klassiek Duits & Hunsrücker streekgerechten',
    priceRange: '€–€€ (± €20 p.p.)',
    description: 'Authentiek familie-landgasthof, royale porties, lokale wildspecialiteiten en rustieke Biergarten.',
    googleMapsQuery: 'Landgasthof Rauland Thalfang Bäsch',
    phone: '+49 6504 91400',
    hours: 'Zo 11–14 & 17–22 · Ma/Di/Do–Za vanaf 17:00 · Wo gesloten',
    recommendedDishes: ['Hunsrücker Spießbraten', 'Wildgoulash', 'Huisgemaakte schnitzels'],
  },
  {
    id: 'am-weiher-thalfang',
    ...
    priceRange: '€€ (± €25 p.p.)',
    description: 'Sfeervol aan het recreatiemeer, zonnig terras, verse forel en seizoensgerechten.',
    googleMapsQuery: 'Restaurant Am Weiher Thalfang',
    phone: '+49 6504 95590',
    hours: 'Controleer even; recent van eigenaar gewisseld (voorheen do+vr 10–17)',
    recommendedDishes: ['Forel Müllerin Art', 'Schnitzel met bospaddenstoelen'],
  },
  {
    id: 'hunsrueckhaus',
    name: 'Café Hunsrückhaus',
    day: 'Dag 1',
    dayLabel: 'Ma 7 sep · Lunch',
    place: 'Erbeskopf',
    address: 'Erbeskopf 54426 Hilscheid',
    cuisine: 'Regionaal bistro & café',
    priceRange: '€ (± €15 p.p.)',
    description: 'Bistro bij het Nationalpark-Tor Erbeskopf, regionale gerechten (open 12:00–17:00).',
    googleMapsQuery: 'Cafe Hunsrueckhaus Erbeskopf',
    phone: '+49 6782 8764366',
    hours: 'Ma–Di gesloten · Wo–Vr 12:00–17:00 · Za–Zo 10:00–17:00',
  },
  // Ma 7 sep — Bernkastel-Kues (avond, Weinfest)
  {
    id: 'alt-bernkastel',
    name: 'Restaurant Alt Bernkastel',
    day: 'Dag 1',
    dayLabel: 'Ma 7 sep · Diner',
    place: 'Bernkastel-Kues',
    address: 'In der Krumme 2, 54470 Bernkastel-Kues',
    cuisine: 'Regionale Duitse keuken',
    priceRange: '€€ (± €30 p.p.)',
    description: 'Beste van de stad (4,4★), regionaal, grote porties en eerlijke prijzen. Reserveer vooraf.',
    googleMapsQuery: 'Restaurant Alt Bernkastel',
    phone: '+49 6531 9729123',
    reserveUrl: 'https://restaurantaltbernkastel.gotoeat.net/',
    hours: 'Zo–Ma 12:00–21:00 · Di gesloten · Wo–Za 12:00–21:00',
    recommendedDishes: ['Schnitzel', 'Wildgerechten', 'Moezelwijn'],
  },
  {
    id: 'schuetzenhaus',
    name: 'Schützenhaus Bernkastel-Kues',
    day: 'Dag 1',
    dayLabel: 'Ma 7 sep · Diner',
    place: 'Bernkastel-Kues',
    address: 'Am Burgberg, 54470 Bernkastel-Kues',
    cuisine: 'Regionaal + Indonesisch, uitzicht',
    priceRange: '€€ (± €35 p.p.)',
    description: 'Prachtig uitzicht over het Moezeldal, regionale én Indonesische specialiteiten.',
    googleMapsQuery: 'Schützenhaus Bernkastel-Kues',
    phone: '+49 6531 2196',
    hours: 'Ma–Di gesloten · Wo–Zo 11:00–21:00 (vr/za soms tot 22:00)',
  },
  {
    id: 'cafe-thiesen',
    name: 'Café Thiesen',
    ...
    dayLabel: 'Ma 7 sep · Diner',
    place: 'Bernkastel-Kues',
    address: 'Am Markt 5, 54470 Bernkastel-Kues',
    cuisine: 'Huiselijk, regionaal & gebak',
    priceRange: '€€ (± €25 p.p.)',
    description: 'Populair, huiselijke sfeer vlakbij de markt, klassieke Duitse gerechten.',
    googleMapsQuery: 'Café Thiesen Bernkastel-Kues',
    phone: '+49 6531 2853',
    hours: 'Dagelijks 11:30–21:30',
  },
  // Di 8 sep — Trier (diner)
  {
    id: 'kesselstatt-trier',
    name: 'Weinstube Kesselstatt',
    day: 'Dag 2',
    dayLabel: 'Di 8 sep · Diner',
    place: 'Trier',
    address: 'Liebfrauenstr. 10, 54290 Trier',
    cuisine: 'Regionaal & wijnbar',
    priceRange: '€€ (± €30 p.p.)',
    description: 'Top-restaurant van Trier, gezellige wijnbar met gerechten; schnitzel ~€20.',
    googleMapsQuery: 'Weinstube Kesselstatt Trier',
    phone: '+49 651 41178',
    reserveUrl: 'https://www.weinstube-kesselstatt.de/',
    hours: 'Dagelijks 11:00–22:00 (keuken 11:30–14:30 & 18:00–21:00)',
    recommendedDishes: ['Schnitzel', 'Seizoensgerechten', 'Trierer Riesling'],
  },
  {
    id: 'brasserie-trier',
    name: 'Brasserie Trier',
    day: 'Dag 2',
    dayLabel: 'Di 8 sep · Diner',
    place: 'Trier',
    address: 'Fleischstr. 12, 54290 Trier',
    cuisine: 'Frans-geïnspireerd, modern',
    priceRange: '€€ (± €35 p.p.)',
    description: 'Modern bistro-concept, populair en goed voor een diner in het centrum.',
    googleMapsQuery: 'Brasserie Trier',
    hours: 'Ma–Za 12:00–23:00 · Zo gesloten',
  },
  {
    id: 'schlemmereule-trier',
    name: 'Restaurant Schlemmereule',
    day: 'Dag 2',
    dayLabel: 'Di 8 sep · Diner',
    place: 'Trier',
    address: 'Krahnenufer 6, 54290 Trier',
    cuisine: 'Regionaal & Europees',
    priceRange: '€€ (± €30 p.p.)',
    description: 'Geprezen en betaalbaar, aan de oevers van de Moezel.',
    googleMapsQuery: 'Restaurant Schlemmereule Trier',
    phone: '+49 651 45376',
    hours: 'Di–Za 12:00–14:30 & 18:00–22:00 · Zo–Ma gesloten',
  },
  // Wo 9 sep — Idar-Oberstein (lunch)
  {
    id: 'spiessbratenhaus',
    name: 'Spießbratenhaus Alte-Kanzlei',
    day: 'Dag 3',
    dayLabel: 'Wo 9 sep · Lunch',
    place: 'Idar-Oberstein',
    address: 'Obersteig 31, 55743 Idar-Oberstein',
    cuisine: 'Hunsrücker grill-specialiteiten',
    priceRange: '€€ (± €25 p.p.)',
    description: 'Dé lokale specialiteit: Spießbraten van open beukenhoutvuur (4,4★).',
    googleMapsQuery: 'Spießbratenhaus Alte-Kanzlei Idar-Oberstein',
    phone: '+49 6781 367733',
    reserveUrl: 'https://www.das-spiessbratenhaus.de/',
    hours: 'Ma–Di 11:00–22:00 · Wo–Do gesloten · Vr–Zo 11:00–22:00',
    recommendedDishes: ['Original Idar-Obersteiner Spießbraten', 'Feuerkartoffeln'],
  },
  {
    id: 'landgasthof-schuck',
    name: 'Landgasthof Schuck',
    day: 'Dag 3',
    dayLabel: 'Wo 9 sep · Lunch',
    place: 'Idar-Oberstein',
    address: 'Vollmersbacher Str. 24, 55743 Idar-Oberstein',
    cuisine: 'Regionaal Duits',
    priceRange: '€€ (± €25 p.p.)',
    description: 'Huiselijke regionale keuken, klassieke Hunsrücker gerechten.',
    googleMapsQuery: 'Landgasthof Schuck Idar-Oberstein',
    hours: 'Do–Di 11:30–14:00 & 17:00–21:00 · Wo gesloten',
  },
  {
    id: 'zum-schleffer',
    name: 'Zum Schleffer',
    ...
    dayLabel: 'Wo 9 sep · Lunch',
    place: 'Idar-Oberstein',
    address: 'In der Schleffer 2, 55743 Idar-Oberstein',
    cuisine: 'Duitse keuken',
    priceRange: '€€ (± €25 p.p.)',
    description: 'Duitse keuken nabij de Felsenkirche, degelijk en gemoedelijk.',
    googleMapsQuery: 'Zum Schleffer Idar-Oberstein',
    phone: '+49 6781 5622953',
    hours: 'Di–Zo vanaf 11:30 · Ma gesloten',
  },
  // Wo 9 sep — Herrstein (diner)
  {
    id: 'zehntscheune-herrstein',
    name: 'Café Zehntscheune',
    day: 'Dag 3',
    dayLabel: 'Wo 9 sep · Diner',
    place: 'Herrstein',
    address: 'Schlossweg 13, 55756 Herrstein',
    cuisine: 'Huiselijk & Kaffee und Kuchen',
    priceRange: '€€ (± €20–25 p.p.)',
    description: 'Beste van Herrstein (4,6★), historische Zehntscheune, ook diner.',
    googleMapsQuery: 'Cafe Zehntscheune Herrstein',
    phone: '+49 6785 1658',
    hours: 'Dagelijks 12:00–20:00 (winter soms tot 17:00)',
  },
  {
    id: 'lillers-herrstein',
    name: "Liller's Historische Weinstube",
    day: 'Dag 3',
    dayLabel: 'Wo 9 sep · Diner',
    place: 'Herrstein',
    address: 'In der Umlauff 2, 55756 Herrstein',
    cuisine: 'Regionaal & wijn',
    priceRange: '€€ (± €30 p.p.)',
    description: 'Historische sfeer in het vakwerkstadje, regionale gerechten en wijn.',
    googleMapsQuery: "Liller's Weinstube Herrstein",
    hours: 'Controleer even (wisselende tijden)',
  },
  {
    id: 'waldschänke-herrstein',
    name: 'Gaststätte Waldschänke',
    day: 'Dag 3',
    dayLabel: 'Wo 9 sep · Diner',
    place: 'Herrstein',
    address: 'Am Wald, 55756 Herrstein',
    cuisine: 'Landelijk, streekgerechten',
    priceRange: '€€ (± €25 p.p.)',
    description: 'Landelijk, stevige Hunsrücker streekgerechten in rustieke sfeer.',
    googleMapsQuery: 'Gaststätte Waldschänke Herrstein',
    hours: 'Controleer even (wisselende tijden)',
  },
  // Do 10 sep — Mörsdorf / Geierlay (diner)
  {
    id: 'gasthof-wendling',
    name: 'Gasthof Wendling',
    day: 'Dag 4',
    dayLabel: 'Do 10 sep · Diner',
    place: 'Mörsdorf',
    address: 'Kastellauner Str. 20, 56290 Mörsdorf',
    cuisine: 'Huiselijke Duitse & winzer-keuken',
    priceRange: '€€ (± €20 p.p.)',
    description: 'Gemoedelijk gasthof nabij de Geierlay-brug, huiselijke keuken.',
    googleMapsQuery: 'Gasthof Wendling Mörsdorf',
    hours: 'Wisselend; doorgaans vanaf 11:00 (keuken tot ~21:00)',
  },
  {
    id: 'restauration-geierlay',
    name: 'Restauration Geierlay (Bezoekerscentrum)',
    day: 'Dag 4',
    dayLabel: 'Do 10 sep · Diner',
    place: 'Mörsdorf',
    address: 'Kastellauner Str. 23, 56290 Mörsdorf',
    cuisine: 'Regionaal, snel & makkelijk',
    priceRange: '€ (± €18 p.p.)',
    description: 'Direct bij de hangbrug, makkelijke en betaalbare maaltijd.',
    googleMapsQuery: 'Restauration Geierlay Mörsdorf',
    hours: 'Dagelijks ~11:00–18:00 (rond de brug)',
  },
  {
    id: 'muehlental-moersdorf',
    name: 'Hotel Restaurant Zum Mühlental',
    day: 'Dag 4',
    dayLabel: 'Do 10 sep · Diner',
    place: 'Mörsdorf',
    address: 'Hauptstraße 24, 56290 Mörsdorf',
    cuisine: 'Regionale & internationale keuken',
    priceRange: '€€ (± €30 p.p.)',
    description: 'Gezinsvriendelijk, ~7,7 km van de brug, goede regionale keuken.',
    googleMapsQuery: 'Hotel Restaurant Zum Mühlental Mörsdorf',
    hours: 'Dagelijks, doorgaans 11:30–14:00 & 17:30–21:00',
  },
];
